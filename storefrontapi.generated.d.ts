...
export type SliderQueryVariables = StorefrontAPI.Exact<{[key: string]: never}>;

export type SliderQuery = {
  metaobjects: {
    nodes: Array<{
      title?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
      texte?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
      cta?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
    }>;
  };
};
...
export type PartenaireQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type PartenaireQuery = {
  metaobjects: {
    nodes: Array<{
      logo?: StorefrontAPI.Maybe<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql \nquery partenaire{\n  metaobjects(type: "partenaire", first: 10) {\n    nodes {\n      logo: field(key: "logo") {\n        reference {\n          ... on MediaImage{\n            previewImage{\n              url\n            }\n          }\n        }\n      }\n      name: field(key: "name") {\n        value\n      }\n    }\n  }\n}': {
    return: PartenaireQuery;
    variables: PartenaireQueryVariables;
  };
